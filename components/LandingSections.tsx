...
export function LandingPage() {
  return (
    // FIX 1: Removed 'h-full overflow-y-auto'. Let the window handle scrolling for native performance.
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/80 backdrop-blur-xl">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* FIX 2: "asChild" prevents invalid HTML nesting (<a> inside <button>) */}
        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              {/* FIX 3: Updated Hero Buttons to use asChild */}
